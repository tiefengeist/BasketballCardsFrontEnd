    ...
    <div>
      ...
      <div className="ui segment inverted grey my-cards">
        ...
        <div className="ui header">{props.team.team_name}</div>
          ...
          <div className="ui row">
          <button className="ui button" value={props.team.team_name} onClick={ev => props.onPlay(ev)}>Play as This Team</button>
          <button className="ui button" value={props.team.id} onClick={ev => props.deleteTeam(ev)}>Delete Team</button>
          </div>
        </div>
      </div>
    </div>
