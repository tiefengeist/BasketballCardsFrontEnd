...
const SoloTeamCard = props => {
  // const {team, onPlay} = props;
  // let imageUrl = "/" + props.team.team_name.replace(/\s+/g, '').toLowerCase() + ".png";
  return (
    <div>
    <button className="ui button" id="backToYourTeamButton" onClick={ev => props.goBack(ev)}>Back to Your Teams</button>
              ...
              <div className="ui column">
                <div className="ui card" >
                  <div className="content">
                    ...
                    <img src="/goldenstatewarriors.png" id="cardImage"  alt=""/>
                    </div>
                    <div className="ui row">
                    <button className="ui button" onClick={ev => props.onVersus(ev)} value="2016 Warriors" id="historicTeamsButton">Play This Team</button>
                    </div>
                  </div>
                </div>
              </div>
              <div className="ui column">
                <div className="ui card">
                  <div className="content">
                    ...
                    <div className="ui image" >
                    <img src="/bostonceltics.png" id="cardImage"  alt=""/>
                    </div>
                    <div className="ui row">
                    <button onClick={ev => props.onVersus(ev)} className="ui button" value="1985 Celtics" id="historicTeamsButton">Play This Team</button>
                    </div>
                  </div>
                </div>
              </div>
              <div className="ui column">
                <div className="ui card">
                  <div className="content">
                    ...
                    <div className="ui image" >
                    <img src='/chicagobulls.png' id="cardImage" alt=""/>
                    </div>
                    <div className="ui row">
                    <button onClick={ev => props.onVersus(ev)} className="ui button" value="1995 Bulls" id="historicTeamsButton">Play This Team</button>
                    </div>
                  </div>
                </div>
              </div>
...
export default SoloTeamCard

// {props.historicTeams.teamName}
